...
\begin{abstract}
Computer programs have been plagued by exploits and bugs relating to manual memory management for a long time.
...
In this context, borrowed capabilities could be seen as a general way of providing a new method for revocation on capability machines.
...
The design is evaluated by constructing example assembly programs that mirror the behavior of certain simple Rust programs.
\end{abstract}
...
Het design wordt geëvalueerd door voorbeeld assembly programma's te construeren die het gedrag van bepaalde simpele Rust programma's nabootsen.
\end{abstract}
\selectlanguage{english}
